...
define $(PKG)_BUILD
    cd '$(SOURCE_DIR)/src/syscfg' && ln -s lock-obj-pub.x86_64-apple-darwin.h lock-obj-pub.darwin18.h
...
#    $(SED) -i 's/host_os = mingw32.*/host_os = mingw32/' '$(BUILD_DIR)/src/Makefile'
    ...
    $(SED) -i 's/-lgpg-error/-lgpg-error -lintl -liconv/;' '$(BUILD_DIR)/src/gpg-error-config'
