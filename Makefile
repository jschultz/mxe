...
MXE_CONFIGURE_OPTS = \
    ...
    CFLAGS='-I$(PREFIX)/$(TARGET)/include $(if $(findstring darwin,$(TARGET)),-mmacosx-version-min=$(shell eval `osxcross-conf`; echo $$OSXCROSS_OSX_VERSION_MIN))' \
...
x86_64-apple-darwin18_EH := seh sjlj
